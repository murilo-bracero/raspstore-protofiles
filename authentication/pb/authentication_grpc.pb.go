...
type AuthServiceClient interface {
	...
	UpdateCredentials(ctx context.Context, in *UpdateCredentialsRequest, opts ...grpc.CallOption) (*Void, error)
...
func (c *authServiceClient) CreateCredentials(ctx context.Context, in *CreateCredentialsRequest, opts ...grpc.CallOption) (*CreateCredentialsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pb.AuthService/createCredentials", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) UpdateCredentials(ctx context.Context, in *UpdateCredentialsRequest, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, "/pb.AuthService/updateCredentials", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	UpdateCredentials(context.Context, *UpdateCredentialsRequest) (*Void, error)
...
func (UnimplementedAuthServiceServer) UpdateCredentials(context.Context, *UpdateCredentialsRequest) (*Void, error) {
...
func _AuthService_CreateCredentials_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.AuthService/createCredentials",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AuthService_UpdateCredentials_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.AuthService/updateCredentials",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
